...
<head>
    ...
    <title><?php echo htmlspecialchars($pageTitle ?? 'Edit Task', ENT_QUOTES, 'UTF-8'); ?></title>
...
<body>
    <main class="container">
        ...
        <h1><?php echo htmlspecialchars($pageTitle ?? 'Edit Task', ENT_QUOTES, 'UTF-8'); ?></h1>
        ...
        <section class="panel">
            <form action="index.php?action=update&id=<?php echo (int) ($task['id'] ?? 0); ?>" method="post" class="form-grid">
